...
def main():
    ...
    parser.add_argument('--labels_dict', action='store', default='', type=str, help='Filename of json file with dictionany of classes to keep. Leave empty to remove classes with less than 100 samples (default: %(default)s).')
